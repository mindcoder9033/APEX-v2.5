  ...
  return (
    <div className="bg-[#0E0E16] rounded-2xl border border-[#232332] p-5 shadow-xl flex flex-col space-y-4">
      <div className="flex items-center justify-between">
        ...
        <span className="text-[11px] font-tech font-bold uppercase tracking-wider text-slate-400 bg-[#161622] px-2.5 py-1 rounded border border-[#262638]">
            ...
            >
              ...
              >
                <div className="flex items-center space-x-3">
                  <div className="w-7 h-7 rounded-lg bg-[#1E1E2C] flex items-center justify-center text-xs font-mono font-bold text-white border border-[#2D2D40] tabular-nums">
                    T{c.cornerIndex}
                  </div>
                  <div>
